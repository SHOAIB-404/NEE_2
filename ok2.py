...
\033[1;31m[\033[1;32m[I]\033[1;31m]\033[1;32m [≠] VERSION   ➤ \033[1;96mPRO//0.4
...
def menu():
	...
	_IPYTHONI_(f'\033[97;1m[\033[92;1m1\033[97;1m] \033[0;92mFILE CLONING ')
...
#SERVER-SETTING			
def Settings():
	print(f'\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91m[\x1b[1;97m1\x1b[1;91m]\x1b[1;97mNEW FB \x1b[1;91m[GOOD]\n\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91m[\x1b[1;97m2\x1b[1;91m]\x1b[1;97mNEW+OLD\x1b[1;93m [BEST]')
...
def passwrd():
	print(50*'═')
	print(f"\x1b[1;97m[+] SHOAIB ON FIRE💥: \x1b[1;97m{ha}\x1b[1;97m/\x1b[1;97m{bu}\x1b[1;97m/\x1b[1;97m{ta} ")
	print(50*'═')
	...
	print(f' \x1b[1;91m\x1b[1;96m\x1b[1;97m SHOAIB: {h}%s '%(ok))
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r [SHOAIB] {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
